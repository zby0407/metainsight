...
class TelegramChannel(Channel):
    ...
    async def _bind_connection_from_start_token(self, update, state_token: str) -> bool:
        ...
        await update.message.reply_text("Telegram connected to MetaInsight.")
        return True
    ...
    async def _cmd_start(self, update, context) -> None:
        ...
        if not self._check_user(update.effective_user.id):
            return
        await update.message.reply_text("Welcome to MetaInsight! Send me a message to start a conversation.\nType /help for available commands.")
