...
def _has_requested_thread_id(body: RunCreateRequest) -> bool:
    return bool((body.config or {}).get("configurable", {}).get("thread_id"))
...
async def stateless_stream(body: RunCreateRequest, request: Request) -> StreamingResponse:
    ...
    record = await start_run(
        ...
        thread_id,
        request,
        allow_missing_thread=not _has_requested_thread_id(body),
    )
