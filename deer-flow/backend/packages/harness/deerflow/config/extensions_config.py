...
class McpServerConfig(BaseModel):
    ...
    session_scope: Literal["thread", "global"] = Field(
        default="thread",
        description=("Persistent stdio session isolation. Use 'thread' for stateful or filesystem-producing servers; use 'global' only for stateless, multi-user-safe servers to avoid per-conversation process startup."),
    )
    model_config = ConfigDict(extra="allow")
