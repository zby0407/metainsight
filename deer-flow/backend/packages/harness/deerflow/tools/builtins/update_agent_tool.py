...
from deerflow.config.agents_config import legacy_shared_agents_enabled, load_agent_config, validate_agent_name
...
def update_agent(
    ...
    if legacy_shared_agents_enabled() and not agent_dir.exists() and paths.agent_dir(agent_name).exists():
