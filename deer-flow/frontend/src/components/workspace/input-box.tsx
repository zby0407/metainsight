...
export function InputBox({
  ...
  placeholder?: string;
  threadId: string;
  welcomeSuggestions?: ReactNode | false;
  initialValue?: string;
  onContextChange?: (
    context: Omit<
      AgentThreadContext,
  ...
  return (
    ...
    >
      ...
      >
        {extraHeader && (
          <div className="absolute top-0 right-0 left-0 z-40 overflow-visible">
            <div className="absolute right-0 bottom-0 left-0 z-40 flex items-center justify-center overflow-visible">
              {extraHeader}
            </div>
          </div>
        )}
      ...
      {isWelcomeMode &&
        ...
        welcomeSuggestions !== false && (
          <div className="flex items-center justify-center pt-2">
            {welcomeSuggestions ?? <SuggestionList />}
          </div>
        )}
