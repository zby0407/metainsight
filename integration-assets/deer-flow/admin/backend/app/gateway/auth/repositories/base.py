...
class UserRepository(ABC):
    ...
    async def count_active_admin_users(self) -> int:
        """Return active administrators (optional for legacy test fakes)."""
        raise NotImplementedError

    async def list_users(self) -> list[User]:
        """Return all users (optional for legacy test fakes)."""
        raise NotImplementedError

    async def get_setting(self, key: str) -> str | None:
        """Read an auth setting (optional for legacy test fakes)."""
        raise NotImplementedError

    async def set_setting(self, key: str, value: str) -> None:
        """Persist an auth setting (optional for legacy test fakes)."""
        raise NotImplementedError
